                                    ...
                                    <form action="SvHabitacion" method="post">
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label for="fechaNac">Fechas:</label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input name="cantidad" type="number" class="form-control" id="piso" placeholder="" value="" required>
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <label for="direccion">Tipo de habitación</label>
