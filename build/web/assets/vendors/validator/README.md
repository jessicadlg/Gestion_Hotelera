...
This is the object which holds all the texts used by the form validator:
    ...
    {
        invalid         : 'el campo no es como se esperaba',
        short           : 'la entrada es demasiado corta',
        long            : 'la entrada es demasiado larga',
        checked         : 'marque el tilde de comprobación',
        empty           : 'por favor debe completar este campo',
        ...
        complete        : 'por favor debe completar el campo'
    }
