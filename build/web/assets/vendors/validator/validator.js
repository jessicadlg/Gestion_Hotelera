    ...
    FormValidator.prototype = {
        ...
        tests : {
            ...
            text : function(field, data){
                var that = this;
                // asegúrese de que hay al menos un número X de palabras, cada una de las cuales tiene al menos 2 caracteres.
                ...
                // comprobar si hay una longitud máxima y la longitud del campo es mayor que la permitida
                if( data.lengthRange && data.lengthRange[1] && data.value.length > data.lengthRange[1] ){
                    return this.texts.long;
                }

                //comprobar si el valor del campo debe obedecer a algún límite de longitud, y si es así, asegurarse de que la longitud del valor es la especificada
